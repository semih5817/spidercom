...
const testimonials = [
  {
    ...
    content: "Avant MT03, je perdais 2h/jour à relancer les devis et à répondre aux mêmes questions. Maintenant tout est automatisé : chatbot la nuit, relances programmées, notifications instantanées. Je me concentre enfin sur mes chantiers. Le ROI a été immédiat.",
    rating: 5
  },
  {
    name: "Sophie L.",
