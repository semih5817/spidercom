        ...
        <section className="px-4 py-20 bg-gradient-to-b from-transparent to-pink-950/20">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="font-inter text-xl text-white/60">
                Découvrez la transformation sur différents types de pièces
              </p>
            </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <div className="text-4xl mb-2">
                          {example.type === "Salon" && "🛋️"}
                          {example.type === "Chambre" && "🛏️"}
                          {example.type === "Cuisine" && "🍳"}
                          {example.type === "Bureau" && "💼"}
                        </div>
                        <p className="text-white/40 text-sm font-inter">Avant → Après</p>
                      </div>
                    </div>
                    <div className="absolute top-2 left-2 px-2 py-1 bg-black/60 rounded text-white text-xs font-inter font-bold backdrop-blur">
                      AVANT
                    </div>
                    <div className="absolute top-2 right-2 px-2 py-1 bg-pink-500/80 rounded text-white text-xs font-inter font-bold backdrop-blur">
                      APRÈS
                    </div>
                  </div>
