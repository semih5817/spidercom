...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[hsl(var(--primary))] via-purple-600 to-[hsl(var(--primary))]">
...
const TechStackSection = () => {
  const technologies = [{
    icon: "⚙️",
    name: "N8N",
    desc: "Orchestration des workflows"
  }, {
    icon: "🤖",
    name: "OpenAI GPT",
    ...
    icon: "📱",
    name: "WhatsApp API",
    desc: "Notifications & rapports"
  }, {
    icon: "🔗",
    name: "Google Business API",
    desc: "Synchronisation données"
  }, {
    icon: "📊",
    name: "Analytics",
    desc: "Métriques temps réel"
  }, {
    icon: "☁️",
    name: "Cloud Storage",
    desc: "Archivage sécurisé"
  }];
  return <section className="py-20 px-4 bg-gradient-to-b from-background via-muted/50 to-background">
      <div className="container mx-auto max-w-6xl">
        <motion.h2 initial={{
        opacity: 0,
        y: 20
  ...
  return <section className="py-20 px-4 bg-gradient-to-b from-background via-muted/50 to-background">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {results.map((result, index) => <motion.div key={result.label} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
  ...
  return <section className="py-20 px-4 bg-gradient-to-br from-[hsl(var(--primary))] via-purple-600 to-[hsl(var(--primary))]">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        delay: 0.2
          ...
          <Button asChild size="lg" className="bg-white text-primary hover:bg-white/90 text-lg px-8 py-6 rounded-full font-bold shadow-xl hover:scale-105 transition-transform">
          ...
          <Button asChild size="lg" variant="outline" className="bg-transparent text-white border-2 border-white hover:bg-white/10 text-lg px-8 py-6 rounded-full font-bold">
            <a href="/contact">
              Demander une démo
